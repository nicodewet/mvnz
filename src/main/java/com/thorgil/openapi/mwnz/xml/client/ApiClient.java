package com.thorgil.openapi.mwnz.xml.client;
...
import com.thorgil.openapi.mwnz.xml.client.auth.Authentication;
...
public class ApiClient extends JavaTimeFormatter {
    ...
    */
    ...
    public boolean isJsonMime(MediaType mediaType) {
        return mediaType != null && (APPLICATION_JSON.isCompatibleWith(mediaType) || mediaType.getSubtype().matches("^.*\\+json[;]?\\s*$"));
    }
